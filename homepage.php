...
<div class="wrapper">
    ...
    <section class="wrap">
      <div class="content">
        <div class="left-column">
            <div class="image-container">
                <img src="asset/img/2.jpg" alt="Image" class="small-image">
            </div>
        </div>
    ...
    <div class="cont">
        <div class="cardd">
            <img src="asset/img/3.jpg" alt="Image 1">
        ...
        <div class="cardd">
            <img src="asset/img/5.jpg" alt="Image 3">
            <div class="card-text">Utilitaire</div>
           
        </div>
        <div class="cardd">
            <img src="asset/img/6.jpg" alt="Image 4">
...
<ul id="accordion" class="accordion">
        ...
        <div class="containe">
            ...
            <div class="cont">
                <div class="cardd">
                    <img src="asset/img/7.jpg" alt="Image 1">
